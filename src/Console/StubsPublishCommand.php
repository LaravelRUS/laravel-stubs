...
class StubsPublishCommand extends Command
{
    ...
    protected $stubs = [
        ...
        'Illuminate/Foundation/Console/stubs/event-handler.stub',
        'Illuminate/Foundation/Console/stubs/event-handler-queued.stub',
        ...
        'Illuminate/Foundation/Console/stubs/routes.stub',
